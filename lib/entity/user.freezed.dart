...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, htmlUrl: $htmlUrl, avatarUrl: $avatarUrl)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, htmlUrl, avatarUrl);
...
abstract class _User implements User {
  const factory _User(
      ...
      @JsonKey(name: 'avatar_url') required final Uri avatarUrl}) = _$UserImpl;
